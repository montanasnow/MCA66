...
preferences {
  ...
  section("MCA-66 Controller") {
    input "ip_address", "text", title: "Controller Address", description: "(ie. 192.168.1.10)", required: true, defaultValue: "192.168.69.123"
...
private addZones(names_json) {
    ...
    for (def i=1; i<7; i++) {
        ...
        addChildDevice("steve28", "MCA-66 Zone", "mca66_zone_${i}", location.hubs[0].id, 
